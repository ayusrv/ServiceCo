...
public class BabySitter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BabySitter.this, UserProfileActivity.class);
        ...
        if(firebaseUser==null){
            Toast.makeText(BabySitter.this, "Something went wrong! User's details are not available at the moment",Toast.LENGTH_LONG).show();
        }
        else{
    ...
    private void showAlertDialog() {
        //Setup alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(BabySitter.this);
        ...
        referenceProfile.child(userUID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readUserDetails != null) {
                    ...
                    Toast.makeText(BabySitter.this, "Something went wrong!", Toast.LENGTH_LONG).show();
                }
            }
