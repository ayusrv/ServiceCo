...
public class Cook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cook.this, UserProfileActivity.class);
        ...
        if(firebaseUser==null){
            Toast.makeText(Cook.this, "Something went wrong! User's details are not available at the moment",Toast.LENGTH_LONG).show();
        }
        else{
    ...
    private void showAlertDialog() {
        //Setup alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(Cook.this);
        ...
        referenceProfile.child(userUID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readUserDetails != null) {
                    ...
                    Toast.makeText(Cook.this, "Something went wrong!", Toast.LENGTH_LONG).show();
                }
            }
